...
# tau1 <- 20; tau_a <- 25; tau <- 35  # C~U(0, tau); W~U(0, tau_a)
...
SAMPLE_SIZE <- function(theta, Pow ,lambda0, p_trt, alpha, alpha0, alpha1, tau1, tau_a, tau, prb, beta_c){
  p <- length(beta_c)
  sigma <- rep(NA,p)
  bb <- c(beta_c,0)
...
#################        Function         ##############
########################################################
SAMPLE_SIZE(theta=0.3, Pow=0.8, lambda0=0.05, p_trt=1/2, alpha=0.05, alpha0=0.3, alpha1=0.0299, 
