...
# theta = 0.3
# Pow = 0.8
# randomization=c("permuted_block") #"SR","CABC","permuted_block"
# 
# lambda0 = 0.05
...
#####################################        Main Program         #############
###############################################################################
SIMU <- function(n, theta, Pow, randomization, lambda0, tau_a, tau, p_trt, alpha, prb, beta_c, case, simu){
...
SIMU(n=428, theta=0.3, Pow=0.8, randomization=c("permuted_block"), lambda0=0.05, tau_a=25, tau=30, 
     p_trt=1/2, alpha=0.05, prb=c(0.5, 0.3, 0.2), beta_c=c(1, 1), case="case1", simu=1000)
